...
async function initApp() {
    ...
    try {
        ...
        // 2. Инициализируем навигацию с загрузкой сохраненного слайда
        ...
        // 5. Запускаем тряску Telegram кнопки
        console.log('📱 Запускаем тряску Telegram...');
        if (typeof window.initTelegramShake === 'function') {
            window.initTelegramShake();
            console.log('✅ Тряска Telegram запущена');
        }
